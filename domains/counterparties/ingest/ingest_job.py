...
class CounterpartyIngestJob:
    """Spark Structured Streaming job for Counterparties domain"""
    ...
    def __init__(self, kafka_brokers: str, schema_registry_url: str, catalog_uri: str, warehouse: str):
        ...
        logger.info("Initialized CounterpartyIngestJob")
    ...
    def run(self) -> None:
        ...
        try:
            ...
            schema_str = '{"merchant_id": "string", "merchant_name": "string", "category": "string", "credit_limit": "double"}'
